...
const _dartPackage = [
  'name: action_app',
  'version: 1.0.0',
  'description: Github action app that helps to run lintme in CI/CD flow.',
  'homepage: https://github.com/dart-code-checker/lintme-action',
  'issue_tracker: https://github.com/dart-code-checker/lintme-action/issues',
  'publish_to: none',
  '',
  'environment:',
  '  sdk: ">=2.12.0 <3.0.0"',
